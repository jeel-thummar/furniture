...
function Checkout({item}) {
	...
	const handleCheckout = async () => {
		try {
		  // Map over each item in cartItems and add it to the 'cart' collection
		  await Promise.all(cartItems.map(async (item) => {
			const cartRef = await addDoc(collection(db, 'cart' + uid), {
			  productUrl : item.productUrl,	
			  productName: item.productname,
			  productPrice: item.productprise,
		      ...
		      <div className="row mb-5">
		        <div className="col-md-12">
		          <div className="border p-4 rounded" role="alert">
		            Returning customer? <a>Click here</a> to login
		          </div>
		        </div>
		      </div>
		      <div className="row">
		          ...
		          <div className="row mb-5">
		            <div className="col-md-12">
		              ...
		              <div className="p-3 p-lg-5 border bg-white">
		                <table className="table site-block-order-table mb-5">
		                  ...
		                  <tbody>
		                    ...
		                    <tr>
		                      ...
		                      <td className="text-black font-weight-bold"><strong>{calculateSubtotal().toFixed(2)}</strong></td>
		                    </tr>
		                  </tbody>
		                </table>

		                <div className="border p-3 mb-3">
		                  <h3 className="h6 mb-0"><a className="d-block" data-bs-toggle="collapse"  role="button" aria-expanded="false" aria-controls="collapsebank">Direct Bank Transfer</a></h3>
		                ...
		                <div className="border p-3 mb-3">
		                  <h3 className="h6 mb-0"><a className="d-block" data-bs-toggle="collapse"  role="button" aria-expanded="false" aria-controls="collapsecheque">Cheque Payment</a></h3>
		                ...
		                <div className="border p-3 mb-5">
		                  <h3 className="h6 mb-0"><a className="d-block" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapsepaypal">Paypal</a></h3>
		                ...
		                <div className="form-group">
		                  <button className="btn btn-black btn-lg py-3 btn-block" onClick={() => handleCheckout(item)}>Place Order</button>
		                </div>
