			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-7 mb-5 mb-lg-0">
						<div class="imgs-grid">
							<div class="grid grid-1"><img src={Images.imggrid1} alt="Untree.co"/></div>
							<div class="grid grid-2"><img src={Images.imggrid2} alt="Untree.co"/></div>
							<div class="grid grid-3"><img src={Images.imggrid3} alt="Untree.co"/></div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="product-item-sm d-flex">
							<div class="thumbnail">
								<img src={Images.product3} alt="Image" class="img-fluid"/>
							</div>
							<div class="pt-3">
		...
		<div class="blog-section">
			<div class="container">
				...
				<div class="row">
					...
					<div class=" blog col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="" class="post-thumbnail"><img src={Images.post1} alt="Image" class="img-fluid"/></a>
							<div class="blog-text post-content-entry">
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="" class="post-thumbnail"><img src={Images.post2} alt="Image" class="img-fluid"/></a>
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="" class="post-thumbnail"><img src={Images.post3} alt="Image" class="img-fluid"/></a>
							<div class="post-content-entry">
