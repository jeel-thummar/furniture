        ...
        <div className="col-xl-4">
            ...
            <div className="card mb-4 mb-xl-0">
                ...
                <div className="card-body text-center">
                    ...
                    <img className="img-account-profile rounded-circle mb-2" src={photoURL} alt="" style={{height:150, width:150}}/>
                    {/* <!-- Profile picture help block--> */}
                    <div className="small font-italic text-muted mb-4"><input type='file'classNameName='filebtn' style={{}} onChange={handleImageChange}/></div>
                    {/* <!-- Profile picture upload button--> */}
                    <button className="btn btn-primary" type="button" onClick={handleSubmit}>Upload new image</button>
                </div>
            </div>
        </div>
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                    <form>
                        ...
                        {/* <!-- Save changes button--> */}
                        <button className="btn btn-primary" type="button" onClick={updateUser}>Save changes</button>
                    </form>
                </div>
            </div>
        </div>
